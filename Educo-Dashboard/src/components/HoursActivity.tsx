...
//   const maxHours = Math.max(...activityData.map((a) => a.hours))
...
//         <div>
//           <h2 className="text-md font-semibold text-gray-900">Hours Activity</h2>
//           <div className="text-xs text-green-600 mt-1">+3% Increase than last week</div>
//         </div>
...
//       {/* Bar Graph */}
//       <div className="relative flex items-end gap-3 h-40 mt-4 px-1">
...
//             <div
//               key={day.day}
//               className="flex flex-col items-center justify-end w-6 relative group"
//               onMouseEnter={() => setHoveredIndex(idx)}
//               onMouseLeave={() => setHoveredIndex(null)}
//             >
//               {/* Tooltip */}
//               {hoveredIndex === idx && (
//                 <div className="absolute -top-16 z-10 bg-black text-white text-xs px-2 py-1 rounded-md shadow text-center">
...
// export default function HoursActivity() {
//   const [hoveredIndex, setHoveredIndex] = useState<number | null>(null)
//   const maxHours = 8 // we fix Y-axis scale to 8 hours for consistent layout
