      ...
      <div className="flex justify-between items-center mb-4">
        <div>
          ...
          <div className="text-xs text-green-600 mt-1 gap-2 flex items-center">
            <MdArrowOutward
              size={20}
              className="inline-block text-black bg-gray-200  rounded-sm p-0.5"
            />
            ...
            {activityData.map((day, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {hoveredIndex === idx && (
                    <div
                      className="absolute   left-1/2 -translate-x-1/2 z-20 bg-black text-white text-xs px-2 py-1 rounded-md shadow text-center min-w-[100px] max-w-[160px]"
                      style={{
